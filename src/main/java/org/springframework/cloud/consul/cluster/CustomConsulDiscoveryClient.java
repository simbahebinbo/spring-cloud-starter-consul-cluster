...
public class CustomConsulDiscoveryClient extends ConsulDiscoveryClient {
  ...
  public List<ServiceInstance> getInstances(String serviceId) {
    ...
    log.info("lansheng228: >>> Before distinct:  Get instances of service({}) from consul : {} <<<", serviceId,
        instances);
    ...
    log.info("lansheng228: >>> After distinct:  Get instances of service({}) from consul : {} <<<", serviceId,
        instances);
